...
#'   Gene2B = c("", "", ""),
#'   Fusion_Type = c("", "", ""),
#'   annots = c("[Cosmic,ChimerPub,ChimerSeq,chimerdb_pubmed,ChimerKB,INTRACHROMOSOMAL[chr7:1.74Mb]]", "[ChimerPub,GTEx,ChimerKB,Greger_Normal,ChimerSeq]", "[INTERCHROMOSOMAL[chr22--chr9]]")
#' )
