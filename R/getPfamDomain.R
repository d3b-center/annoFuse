...
getPfamDomain <- function(standardFusioncalls=standardFusioncalls,bioMartDataPfam=bioMartDataPfam,keepPartialAnno=FALSE)
{
  ...
  standardFusioncallsGene1A <- standardFusioncalls %>% left_join(bioMartDataPfam, by=c("Gene1A"="hgnc_symbol")) %>% as.data.frame()
  standardFusioncallsGene1B <- standardFusioncalls %>% left_join(bioMartDataPfam, by=c("Gene1B"="hgnc_symbol")) %>% as.data.frame()
