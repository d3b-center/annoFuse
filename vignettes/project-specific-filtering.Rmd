...
fusion_calls<-aggregate_fusion_calls(fusion_calls)
...
fusion_calls.summary <- called_by_n_samples(fusion_calls,numCaller)
...
fusion_recurrent5_per_sample <- fusionMultifused(fusion_calls ,limitMultiFused)
...
plotSummary(fusion_calls,groupby = "broad_histology")
