...
Or are recurrent fusions called by both callers and unique to specific histology in this filtered dataset. If fusions are from non-oncogenic genes that are fused more than 5 times per sample we consider these are artifacts and remove them from being further processed  
...
```{r}
# PLot summary
p3 <- plot_summary(standardFusioncalls = putative_driver_fusions, 
                   groupby = "broad_histology", 
