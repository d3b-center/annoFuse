---
title: "Putative Driver filtering"
output: rmarkdown::html_vignette
---

In this vignette we demonstrates using annoFuse, to filter putative oncogene fusion from a filtered fusion list (filtered fusion list `FilteredFusionAnnoFuse.tsv` was obtained for v16 OpenPBTA files : fusion_standardization -> fusion_filtering_QC -> annotate_fusion_calls ) and also plot recurrent fusion,recurrently fused genes and summary plot.
...
putative_driver_fusions<-putative_driver_fusions %>%
  ...
  dplyr::filter(!FusionName %in% found_in_morethan_4$FusionName,
