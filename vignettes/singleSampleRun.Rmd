...
standardFusioncalls<-annoFuse::annoFuseSingleSample(
...
plotBreakpoints(domainDataFrame = kiaabraf,exons = exons,geneposition = "Right")+theme_Publication(base_size = 12)
```
