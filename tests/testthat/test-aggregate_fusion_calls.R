...
test_that("Aggregate fusion calls output from non-empty arriba and starfusion fusion calls", {
  expect_equal(colnames(aggregate_fusion_calls_out), c("LeftBreakpoint","RightBreakpoint","FusionName","Sample","Caller","Fusion_Type","JunctionReadCount","SpanningFragCount","Confidence","annots","Gene1A","Gene2A","Gene1B","Gene2B","BreakpointLocation","SpanningDelta","reciprocal_exists","Gene1A_anno","Gene1B_anno","Gene2A_anno","Gene2B_anno" ,"Fusion_anno", "CalledBy","caller_count" ))
